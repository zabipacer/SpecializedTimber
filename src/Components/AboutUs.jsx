    ...
    <div id='why-choose-us' className="bg-beige p-10 md:p-20">
      <div className="flex flex-col md:flex-row items-center">
        <div className="md:w-1/2 md:pr-10">
          ...
          At STP, we focus on harvesting Lesser Used Species (LUS), which are sustainably abundant and
essential to preserving the biodiversity of our Rainforests. By steam-treating LUS to resemble primary
species, we reduce the demand for endangered wood while ensuring the regularity & reliability of
quality wood supply to our clients.
   </p>
